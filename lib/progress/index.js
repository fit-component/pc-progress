...
var Progress = function (_React$Component) {
    ...
    _createClass(Progress, [{
        ...
        value: function render() {
            ...
            var others = _objectWithoutProperties(_props, ['className', 'children', 'percent', 'status']);
            ...
            var statusFinally = status;
            if (parseInt(percent) === 100) {
                statusFinally = 'success';
            }

            var progressClasses = (0, _classnames2.default)(_defineProperty({
                progress: true
            }, statusFinally, true));
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { className: progressClasses,
                    style: { width: percent + '%' } })
            );
        }
    }]);
